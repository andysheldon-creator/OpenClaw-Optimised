...
const checks = [
  ...
  { path: 'models.default.maxOutputTokens', expected: 2048, actual: redacted.models.default.maxOutputTokens },
  { path: 'models.default.minTokens', expected: 100, actual: redacted.models.default.minTokens },
  { path: 'channels.discord.token', expected: REDACTED_SENTINEL, actual: redacted.channels.discord.token },
  { path: 'channels.discord.botToken', expected: REDACTED_SENTINEL, actual: redacted.channels.discord.botToken },
  { path: 'channels.telegram.botToken', expected: REDACTED_SENTINEL, actual: redacted.channels.telegram.botToken },
  { path: 'channels.telegram.maxTokens', expected: 8192, actual: redacted.channels.telegram.maxTokens },
  { path: 'channels.openai.apiKey', expected: REDACTED_SENTINEL, actual: redacted.channels.openai.apiKey },
  { path: 'channels.openai.authToken', expected: REDACTED_SENTINEL, actual: redacted.channels.openai.authToken },
  { path: 'channels.openai.tokenLimit', expected: 128000, actual: redacted.channels.openai.tokenLimit },
...
checks.forEach(check => {
  ...
  console.log(`${passed ? '✅' : '❌'} ${check.path}: ${passed ? 'PASS' : `FAIL (expected ${JSON.stringify(check.expected)}, got ${JSON.stringify(check.actual)})`}`);
