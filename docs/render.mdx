...
services:
  - type: web
    ...
    dockerCommand: sh -c "mkdir -p /data/.openclaw /home/node/.openclaw && rm -f /data/.openclaw/*.json /home/node/.openclaw/*.json && echo '{\"gateway\":{\"controlUi\":{\"dangerouslyDisableDeviceAuth\":true}}}' | tee /data/.openclaw/openclaw.json /home/node/.openclaw/openclaw.json && node dist/index.js gateway --bind lan --port 8080"
    envVars:
      - key: PORT
        value: "8080"
      - key: SETUP_PASSWORD
