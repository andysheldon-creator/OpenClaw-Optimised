...
| 18. F5     | ClawHub                               | 19. เอเจนต์ | 20. โค้ดสกิล                            | Moderation, scanning                          |
...
| **Description**                                           | 33. ผู้โจมตีสแกนหาเอ็นด์พอยต์เกตเวย์ OpenClaw ที่เปิดเผย                     |
...
| **คอมโพเนนต์ที่ได้รับผลกระทบ** | Agent LLM, all input surfaces                                                            |
...
| 5. **ความเสี่ยงคงค้าง**           | Low - Tools generally documented                                  |
...
| **Description**                                           | 13. ผู้โจมตีดึงข้อมูลอ่อนไหวจากบริบทของเซสชัน                       |
...
| 25. แอตทริบิวต์                    | ค่า                                                                                             |
| --------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| 26. **รหัส ATLAS**                 | AML.T0009 - Collection                                                          |
...
| Control                         | Implementation                                                   | ประสิทธิผล                                               |
| ------------------------------- | ---------------------------------------------------------------- | -------------------------------------------------------- |
...
| --------------------- | ----------------------------------------------------- | ---------------------------------------------------------------------- |
| การผสานรวม VirusTotal | อยู่ระหว่างดำเนินการ                                  | High - Code Insight behavioral analysis                                |
| การรายงานโดยชุมชน     | บางส่วน (มีตาราง `skillReports`)   | ปานกลาง                                                                |
| การบันทึกการตรวจสอบ   | Partial (`auditLogs` table exists) | ปานกลาง                                                                |
