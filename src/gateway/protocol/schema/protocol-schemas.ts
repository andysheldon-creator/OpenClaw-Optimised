...
export const ProtocolSchemas: Record<string, TSchema> = {
  ...
  NodeHealthTelemetryFrame: NodeHealthTelemetryFrameSchema,
  NodeHealthTelemetryEntry: NodeHealthTelemetryEntrySchema,
  NodeHealthGetParams: NodeHealthGetParamsSchema,
