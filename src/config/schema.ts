...
const FIELD_LABELS: Record<string, string> = {
  ...
  "channels.matrix.homeserver": "Matrix Homeserver",
  ...
  "channels.matrix.deviceName": "Matrix Device Name",
  "channels.matrix.autoJoin": "Matrix Auto-Join",
  "channels.matrix.autoJoinAllowlist": "Matrix Auto-Join Allowlist",
  "channels.matrix.groupPolicy": "Matrix Group Policy",
  "channels.matrix.allowlistOnly": "Matrix Allowlist Only",
  "channels.matrix.textChunkLimit": "Matrix Text Chunk Limit",
  "channels.matrix.mediaMaxMb": "Matrix Media Max (MB)",
  "channels.matrix.replyToMode": "Matrix Reply-To Mode",
  "channels.matrix.threadReplies": "Matrix Thread Replies",
  "channels.matrix.initialSyncLimit": "Matrix Initial Sync Limit",
  "channels.matrix.dm.policy": "Matrix DM Policy",
  "channels.matrix.dm.allowFrom": "Matrix DM Allowlist",
  "channels.matrix.rooms": "Matrix Rooms",
...
const FIELD_HELP: Record<string, string> = {
  ...
  "channels.matrix.dm.policy":
    'Direct message access control ("pairing" recommended). "open" allows anyone to DM; include channels.matrix.dm.allowFrom=["*"] to make it explicit.',
