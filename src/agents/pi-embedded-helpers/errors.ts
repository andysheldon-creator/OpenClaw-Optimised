 ...
 * Falls back to the generic BILLING_ERROR_USER_MESSAGE when no payment info is present.
 */
export function formatBillingErrorMessage(paymentInfo?: X402PaymentInfo | null): string {
  if (!paymentInfo) {
