---
name: code-review
description: Review code changes on the current branch against main. Checks for errors, quality issues, and consistency with existing codebase patterns.
license: MIT
metadata:
  author: openclaw
  version: "1.0"
...
- `--focus <area>`: Focus review on specific area (security, performance, style, tests)
