...
## Current Phase
Week 1–2: Deploy OpenClaw internally, then fork and strip for business use.

## Key Reference Files
- `docs/openclaw-fork-plan.md` — Technical implementation plan for the fork
- `docs/vertical-skills.md` — Skill specifications for each vertical
- `docs/security-hardening.md` — Security requirements for regulated industry deployments
- `docs/pricing-economics.md` — Unit economics and pricing logic
- `docs/discovery-process.md` — Sales process and workflow audit framework
...
- Keep CLAUDE.md lean; reference docs/ files for detail
